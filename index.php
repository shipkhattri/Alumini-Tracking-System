...
<div class="wrapper">
	...
	<div class="messages-sec">
		<div class="row">
			<div  style=" margin: 10px;  top: 8%;  bottom: 0;  width: 30%; overflow-y: scroll; scrollbar-width: none; ">
				<div id="user_details"></div>
			</div>		
			
			<div style="  padding:10px 0 0 0; position: relative;  top: 5%;  left: 0%; bottom: 0;  width: 61%; ">
